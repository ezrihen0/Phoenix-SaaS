...
export const FIELD_KNOWLEDGE_DOMAIN_DOORS_WINDOWS = "doors_windows";

export const FIELD_KNOWLEDGE_APPROVED_DOMAINS = [
...
export const ALBERTA_V1_KNOWLEDGE_FILES: Record<AlbertaV1KnowledgeKey, string> = {
  ...
  ca_ab_doors_windows_trade_map_basics_v1:
    "trades/doors-windows/canada/alberta/doors-windows-trade-map-basics-v1.md",
  ca_ab_doors_windows_residential_diagnostics_basics_v1:
    "trades/doors-windows/canada/alberta/doors-windows-residential-diagnostics-basics-v1.md",
  ca_ab_doors_windows_dispatcher_triage_basics_v1:
    "trades/doors-windows/canada/alberta/doors-windows-dispatcher-triage-basics-v1.md",
  ca_ab_doors_windows_report_wording_basics_v1:
    "trades/doors-windows/canada/alberta/doors-windows-report-wording-basics-v1.md",
  ca_ab_doors_windows_photo_intake_safety_v1:
    "trades/doors-windows/canada/alberta/doors-windows-photo-intake-safety-v1.md",
  ca_ab_windows_screen_service_basics_v1:
    "trades/doors-windows/canada/alberta/windows-screen-service-basics-v1.md",
  ca_ab_doors_windows_service_opportunity_basics_v1:
    "trades/doors-windows/canada/alberta/doors-windows-service-opportunity-basics-v1.md",
};
