...
export const requiredColumns = [
  ...
  },
  {
    ...
    columns: [
      ...
      "model_id",
      "dismissed_at",
      "outbound_txt_message_id",
      "created_at",
      "updated_at",
    ],
  },
  { table: "customers", columns: ["organization_id", "full_name", "phone", "lifecycle_status"] },
  { table: "leads", columns: ["organization_id", "customer_id", "status"] },
  { table: "leads", columns: ["organization_id", "disposition"] },
  {
    table: "public_booking_submissions",
    columns: [
      "organization_id",
      "idempotency_key",
      "lead_id",
  ...
  { table: "quotes", columns: ["organization_id", "job_id", "status"] },
  {
    ...
    columns: [
      ...
      "pricebook_item_id",
      "pricebook_bundle_id",
      "bundle_requirement_id",
      "catalog_unit_price_cents_snapshot",
      "sort_order",
    ],
  },
  ...
  { table: "invoice_payments", columns: ["organization_id", "invoice_id", "idempotency_key"] },
  {
  ...
  { table: "pricebook_items", columns: ["organization_id", "internal_sku", "image_storage_key", "category_id"] },
  { table: "pricebook_categories", columns: ["organization_id", "system_id", "name", "archived_at"] },
  { table: "pricebook_systems", columns: ["organization_id", "name", "code", "archived_at"] },
  ...
  { table: "pricebook_bundle_requirements", columns: ["organization_id", "bundle_id", "category_id", "label"] },
  ...
  { table: "txt_conversations", columns: ["organization_id", "public_conversation_code", "owned_phone_number_id", "customer_phone_number_normalized"] },
  { table: "txt_messages", columns: ["organization_id", "conversation_id", "provider_message_id", "status"] },
  { table: "sms_templates", columns: ["name", "is_active", "sort_order", "quick_pick_order"] },
  { table: "call_flow_configs", columns: ["organization_id", "config_name", "is_active", "time_zone"] },
  ...
  { table: "missed_call_sms_settings", columns: ["organization_id", "settings_key", "is_enabled", "cooldown_seconds"] },
  ...
  { table: "stripe_webhook_event_receipts", columns: ["stripe_event_id"], isUnique: true },
  {
...
export const requiredIndexes = [
  ...
  { table: "technicians", columns: ["organization_id", "auth_user_id"], isUnique: true },
  ...
  { table: "platform_operator_grants", columns: ["user_id", "capability"], isUnique: true },
  { table: "platform_operator_grants", columns: ["user_id", "revoked_at"], isUnique: false },
  { table: "ai_recommendation_runs", columns: ["organization_id", "created_at"], isUnique: false },
  {
    table: "ai_recommendation_runs",
    columns: ["organization_id", "action_key", "created_at"],
    isUnique: false,
  },
  {
    table: "ai_operator_drafts",
    columns: ["organization_id", "recent_call_id", "draft_type"],
    isUnique: false,
  },
  { table: "ai_operator_drafts", columns: ["organization_id", "status"], isUnique: false },
  ...
  { table: "invoice_line_items", columns: ["invoice_id", "document_line_key"], isUnique: true },
  {
    ...
    columns: ["organization_id", "invoice_id", "idempotency_key"],
    isUnique: true,
  },
  {
    table: "public_booking_submissions",
  ...
  {
    table: "public_booking_submissions",
    columns: ["organization_id", "phone_last_10", "created_at"],
    isUnique: false,
  },
  {
    table: "public_booking_submissions",
    columns: ["organization_id", "client_ip_hash", "created_at"],
    isUnique: false,
  },
  {
    table: "warranty_certificates",
  ...
  {
    table: "warranty_certificates",
    columns: ["organization_id", "related_invoice_id"],
    isUnique: false,
  },
  { table: "pricebook_items", columns: ["organization_id", "internal_sku"], isUnique: true },
  { table: "pricebook_items", columns: ["category_id"], isUnique: false },
  { table: "pricebook_categories", columns: ["organization_id", "system_id", "name"], isUnique: true },
  { table: "pricebook_systems", columns: ["organization_id", "code"], isUnique: true },
  { table: "pricebook_systems", columns: ["organization_id", "name"], isUnique: true },
  { table: "pricebook_categories", columns: ["system_id"], isUnique: false },
  ...
  { table: "customers", columns: ["organization_id", "lifecycle_status"], isUnique: false },
  { table: "leads", columns: ["organization_id", "customer_id"], isUnique: false },
  { table: "leads", columns: ["organization_id", "status"], isUnique: false },
  { table: "leads", columns: ["organization_id", "disposition"], isUnique: false },
  ...
  { table: "txt_conversations", columns: ["organization_id"], isUnique: false },
  { table: "txt_conversations", columns: ["organization_id", "owned_phone_number_normalized", "customer_phone_number_normalized", "is_archived"], isUnique: true },
  { table: "txt_conversations", columns: ["organization_id", "customer_phone_number_normalized", "is_archived"], isUnique: false },
  { table: "txt_messages", columns: ["organization_id"], isUnique: false },
  { table: "txt_messages", columns: ["conversation_id", "created_at"], isUnique: false },
  { table: "txt_messages", columns: ["provider", "provider_message_id"], isUnique: true },
  ...
  { table: "call_flow_configs", columns: ["organization_id", "is_active"], isUnique: false },
  { table: "missed_call_sms_settings", columns: ["organization_id"], isUnique: false },
...
export const requiredForeignKeys = [
  ...
  {
    table: "ai_operator_drafts",
    column: "recent_call_id",
    referencedTable: "recent_calls",
    referencedColumn: "id",
  },
  {
    table: "ai_operator_drafts",
    column: "recommendation_run_id",
    referencedTable: "ai_recommendation_runs",
    referencedColumn: "id",
  },
  {
    table: "ai_operator_drafts",
    column: "outbound_txt_message_id",
    referencedTable: "txt_messages",
    referencedColumn: "id",
  },
  { table: "customers", column: "organization_id", referencedTable: "organizations", referencedColumn: "id" },
  { table: "leads", column: "customer_id", referencedTable: "customers", referencedColumn: "id" },
  {
    table: "public_booking_submissions",
    column: "organization_id",
    referencedTable: "organizations",
  ...
  },
  {
    table: "pricebook_categories",
    column: "system_id",
    referencedTable: "pricebook_systems",
    referencedColumn: "id",
  },
  {
    table: "pricebook_systems",
    column: "organization_id",
    referencedTable: "organizations",
    referencedColumn: "id",
  },
  {
    ...
    column: "category_id",
    referencedTable: "pricebook_categories",
    referencedColumn: "id",
  },
] as const;
