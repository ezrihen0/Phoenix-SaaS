...
type InvoicePricebookPickerProps = {
  onAddItem: (item: PricebookItem) => void;
  onAddBundle: (bundle: PricebookBundleDetail) => void;
};

export default function InvoicePricebookPicker({
  onAddItem,
  onAddBundle,
}: InvoicePricebookPickerProps) {
  ...
  const emptyMessage = useMemo(() => {
    ...
    return "Search the pricebook to add items or bundles to this invoice.";
  }, [query]);
