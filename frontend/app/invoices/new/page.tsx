...
type NewInvoiceRedirectContext = {
...
export default async function NewInvoiceRedirectPage({ searchParams }: NewInvoiceRedirectContext) {
  ...
  redirect(queryString ? `/invoices/create?${queryString}` : "/invoices/create");
}
