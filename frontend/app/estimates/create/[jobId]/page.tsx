...
import EstimateCreateWorkspace from "./estimate-create-workspace";
import type { JobQuoteRecord } from "@/app/jobs/[jobId]/job-quote-section";
...
type EstimateCreateJobPageContext = {
  params: Promise<{
    jobId: string;
  }>;
};
...
export default async function EstimateCreateJobPage({ params }: EstimateCreateJobPageContext) {
  const { jobId } = await params;
  await requireServerPermission(`/estimates/create/${jobId}`, "estimates.manage");
