...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 lg:px-10 lg:py-20">
      ...
      <h1 className="mt-8 font-[family:var(--font-flat-display)] text-4xl tracking-tight text-[color:var(--sem-display-headline)]">
        Privacy Policy
      </h1>
      ...
      <section className="mt-10 space-y-4 text-sm leading-7 text-[color:var(--sem-text-secondary)]">
        <p>
