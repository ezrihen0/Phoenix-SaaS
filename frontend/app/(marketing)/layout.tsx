      ...
      <footer className="border-t border-[color:var(--cmp-border-subtle)] px-6 py-8 text-sm text-[color:var(--sem-text-muted)] lg:px-10">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/terms" className="transition hover:text-[color:var(--sem-text-primary)]">
              Terms
            </Link>
            <Link href="/privacy" className="transition hover:text-[color:var(--sem-text-primary)]">
              Privacy
            </Link>
            <Link href="/contact" className="transition hover:text-[color:var(--sem-text-primary)]">
              Contact
            </Link>
            <Link href="/login" className="transition hover:text-[color:var(--sem-text-primary)]">
              Sign in
            </Link>
          </div>
        </div>
