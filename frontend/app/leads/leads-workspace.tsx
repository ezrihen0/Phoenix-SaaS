  ...
  return (
    <div className="mt-7 space-y-5">
      ...
      <div className="hidden lg:block">
        {displayMode === "ledger" ? (
          <>
            <div className="leads-display-ledger theme-control-surface overflow-hidden rounded-[24px] border border-[color:var(--cmp-border-subtle)] bg-[linear-gradient(180deg,rgba(20,20,20,0.92),rgba(12,12,12,0.92))]">
              <MasterTable
            ...
            <div className="space-y-3">
              {leads.length > 0 ? paginatedLeadsByMode.hybrid.items.map((lead) => {
                ...
                return (
                  <article
                    key={lead.id}
                    className={`theme-control-surface rounded-[28px] border border-[color:var(--cmp-border-subtle)] bg-[linear-gradient(180deg,rgba(20,20,20,0.92),rgba(12,12,12,0.92))] px-5 py-4 shadow-[0_18px_36px_rgba(0,0,0,0.22)] ${lead.id === editingLeadId ? "ring-1 ring-[color:var(--cmp-focus-ring)]" : ""}`}
                  >
                    <div
            ...
            <div className="grid gap-4 xl:grid-cols-3 2xl:grid-cols-4">
              {leads.length > 0 ? paginatedLeadsByMode.grid.items.map((lead) => {
                ...
                return (
                  <article
                    key={lead.id}
                    className={`theme-control-surface flex h-full flex-col rounded-[28px] border border-[color:var(--cmp-border-subtle)] bg-[linear-gradient(180deg,rgba(20,20,20,0.92),rgba(12,12,12,0.92))] p-5 shadow-[0_18px_36px_rgba(0,0,0,0.22)] ${lead.id === editingLeadId ? "ring-1 ring-[color:var(--cmp-focus-ring)]" : ""}`}
                  >
                    <div className="space-y-3" onClick={(event) => event.stopPropagation()}>
                      {renderLeadActions(lead, draftStatus, canEditStatus)}
                    </div>
      ...
      <div className="grid gap-4 lg:hidden">
        {leads.length > 0 ? leads.map((lead) => (
          <article key={lead.id} className="theme-control-surface-soft rounded-[24px] border border-[color:var(--cmp-border-subtle)] bg-[linear-gradient(180deg,rgba(26,26,26,0.86),rgba(16,16,16,0.9))] p-4">
      ...
      {editingLead && editForm ? (
        ...
        >
          <div
            className="theme-surface-modal w-full max-w-2xl rounded-[28px] border border-[color:var(--cmp-border-subtle)] bg-[linear-gradient(180deg,rgba(18,18,18,0.96),rgba(10,10,10,0.9))] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.38)]"
      ...
      {isIntakeOpen ? (
        ...
        >
          <div
            className="theme-surface-modal w-full max-w-3xl rounded-[28px] border border-[color:var(--cmp-border-subtle)] bg-[linear-gradient(180deg,rgba(18,18,18,0.96),rgba(10,10,10,0.9))] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.38)]"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-start justify-between gap-4">
              <div>
