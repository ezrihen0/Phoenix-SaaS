...
> **HISTORICAL REVIEW COPY — not current authority.** Use [`../WizField_AI_Master_Source_of_Truth.md`](../WizField_AI_Master_Source_of_Truth.md) for Home AI V1 and current AI boundaries.
