...
> **HISTORICAL REVIEW COPY — not current authority.** Use [`../WizField_Language_Store_Source_of_Truth.md`](../WizField_Language_Store_Source_of_Truth.md).

**Document status:** Historical review copy (not current authority)  
**Project:** WizField  
