...
> **HISTORICAL REVIEW COPY — not current authority.** Use [`../WizField_Master_Source_of_Truth.md`](../WizField_Master_Source_of_Truth.md). Stripe-first statements below are stale.
