...
> **HISTORICAL REVIEW COPY — not current authority.** Use [`../WizField_AI_Brain_V1_Home_Intelligence_SPEC.md`](../WizField_AI_Brain_V1_Home_Intelligence_SPEC.md). Home AI chat is a different surface.
