...
> **HISTORICAL REVIEW COPY — not current authority.** Use [`../WizField_Engineering_Closeout_and_Verification.md`](../WizField_Engineering_Closeout_and_Verification.md) and the [September 2026 production closeout](../audit/production-2026-09/WIZFIELD_PRODUCTION_CLOSEOUT.md).
